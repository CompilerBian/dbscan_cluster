...
def pcl_callback(pcl_msg):
  ...
  clusters = get_clusters(cloud, tolerance=0.05, min_size=100, max_size=1500)
...
if __name__ == '__main__':
  ...
  subscriber = rospy.Subscriber(
      "/segmenter/points_nonground", pc2.PointCloud2, pcl_callback, queue_size=1)
  ...
  clusters_publisher = rospy.Publisher(
